...
"!!DX11VertexSM40
					...
					mov o2.xyz, v0.xyzx
					mov o2.w, l(1.000000)
					mul r0.xyz, v0.yyyy, cb0[9].xywx
					mad r0.xyz, cb0[8].xywx, v0.xxxx, r0.xyzx
					mad r0.xyz, cb0[10].xywx, v0.zzzz, r0.xyzx
					add r0.xyz, r0.xyzx, cb0[11].xywx
					div r0.xy, r0.xyxx, r0.zzzz
					mad o3.xy, r0.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
					ret 
...
"!!DX10Level9Vertex
					...
					//
					    ...
					    dcl_texcoord v0
					    dcl_texcoord1 v1
					    mul r0.xyz, v0.y, c2.xyww
					    mad r0.xyz, c1.xyww, v0.x, r0
					    mad r0.xyz, c3.xyww, v0.z, r0
					    add r0.xyz, r0, c4.xyww
					    rcp r0.z, r0.z
					    mul r0.xy, r0.z, r0
					    mad oT2.xy, r0, c9.x, c9.x
					    mul r0, v0.y, c6
					    mad r0, c5, v0.x, r0
					    mad r0, c7, v0.z, r0
					    mad r0, c8, v0.w, r0
					    ...
					    mov oPos.zw, r0
					    mov oT0.xyz, v1
					    mad oT1, v0.xyzx, c9.yyyz, c9.zzzy
...
"!!DX9PixelSM20
					...
					//   Name                         Reg   Size
					//   ---------------------------- ----- ----
					//   unity_World2Shadow           c0       8
					//   unity_LightColor0            c8       1
					//   unity_LightColor1            c9       1
					//   unity_LightPosition0         c10      1
...
"!!DX11PixelSM40
					...
					mad r0.x, r2.x, r0.x, r0.z
					and r0.x, r0.x, r0.y
					mov r3.x, cb2[12].y
					mov r3.y, cb2[13].y
					mov r3.z, cb2[14].y
					mov r3.w, cb2[15].y
					dp4 r0.y, r3.xyzw, v2.xyzw
					...
					mov r3.w, cb2[15].z
					dp4 r0.y, r3.xyzw, v2.xyzw
					mad_sat r0.z, -r0.y, l(0.250000), l(1.000000)
					...
					mov r3.z, cb2[14].w
					mov r3.w, cb2[15].w
					dp4 r0.z, r3.xyzw, v2.xyzw
					mad_sat r0.w, -r0.z, l(0.250000), l(1.000000)
					...
					mad o0.xyz, r0.xxxx, r0.yzwy, cb1[1].xyzx
					mov o0.w, l(1.000000)
					ret 
					// Approximately 0 instruction slots used"
}
...
"!!DX10Level9Pixel
					...
					//
					    ...
					    dp4 r0.x, r0, t1
					    add r0.y, -r0.x, c7.x
					    mad_sat r0.x, r0.x, -c7.y, c7.z
					    texld_pp r1, t2, s0
					    texld_pp r2, t2, s1
					    lrp r3.w, r0.x, r1.x, r2.x
					    cmp r0.x, r0.y, c7.w, r3.w
					    mov r3.x, c3.y
					    mov r3.y, c4.y
					    mov r3.z, c5.y
					    mov r3.w, c6.y
					    dp4 r0.y, r3, t1
					    add r0.z, -r0.y, c7.x
					    mad_sat r0.y, r0.y, -c7.y, c7.z
					    lrp r3.x, r0.y, r1.y, r2.y
					    cmp r0.y, r0.z, c7.w, r3.x
					    max r1.x, r0.x, r0.y
					    mov r0.x, c3.z
					    mov r0.y, c4.z
					    mov r0.z, c5.z
					    mov r0.w, c6.z
					    dp4 r0.x, r0, t1
					    mad_sat r0.y, r0.x, -c7.y, c7.z
					    add r0.x, -r0.x, c7.x
					    lrp r3.x, r0.y, r1.z, r2.z
					    cmp r0.x, r0.x, c7.w, r3.x
					    mov r3.x, c3.w
					    mov r3.y, c4.w
					    mov r3.z, c5.w
					    mov r3.w, c6.w
					    dp4 r0.y, r3, t1
					    mad_sat r0.z, r0.y, -c7.y, c7.z
					    add r0.y, -r0.y, c7.x
					    lrp r3.x, r0.z, r1.w, r2.w
					    cmp r0.y, r0.y, c7.w, r3.x
					    max r1.y, r0.x, r0.y
					    max r0.x, r1.x, r1.y
					    add r0.x, -r0.x, c7.z
					    add r1.xyz, -t1, c0
					    ...
					    mul_pp r0.x, r0.x, r0.y
					    mov r1.xyz, c2
					    add_pp r0.yzw, -r1.wzyx, c1.wzyx
					    mad_pp r0.xyz, r0.x, r0.wzyx, c2
					    mov r0.w, c7.z
					    mov_pp oC0, r0
